...
execute as @a[team=blue_team] at @s unless entity @s[nbt={Inventory:[{Slot:103b,tag:{Flag:1b},id:"minecraft:lapis_block"}]}] if block ~ ~-1 ~ minecraft:lapis_block if block ~ ~-2 ~ minecraft:beacon if score lapis monument matches 0..0 run tag @s add grant_lapis_flag
...
execute as @a[team=blue_team] at @s unless entity @s[nbt={Inventory:[{Slot:103b,tag:{Flag:1b},id:"minecraft:emerald_block"}]}] if block ~ ~-1 ~ minecraft:emerald_block if block ~ ~-2 ~ minecraft:beacon if score emerald monument matches 0..0 run tag @s add grant_emerald_flag
